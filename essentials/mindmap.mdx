...
flowchart LR
    ...
    classDef root fill:#16a34a,color:#052e16,stroke:#bbf7d0,stroke-width:3px,font-weight:bold;
    classDef section fill:#0f2a22,color:#ecfdf5,stroke:#34d399,stroke-width:2px;
    classDef leaf fill:#111827,color:#e5e7eb,stroke:#475569,stroke-width:1.5px;
